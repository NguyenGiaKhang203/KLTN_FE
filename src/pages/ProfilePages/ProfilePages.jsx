...
import { WrapperContentProfile, WrapperHeader, WrapperInput, WrapperLabel, WrapperUploadFile, WrapperButton } from './style'
...
const ProfilePage = () => {
    ...
    const handleUpdate = () => {
        const address = [street, wardName, districtName, provinceName].filter(Boolean).join(', ')
        mutation.mutate({
            id: user?.id,
            name: studentName,
            email,
            ...
            {/* <Loading isLoading={isLoading}> */}
                <WrapperContentProfile>
                    <WrapperInput>
                        ...
                        <InputForm value={studentName} onChange={setStudentName} placeholder="Tên học viên" />
                    </WrapperInput>
                    ...
                    <WrapperInput>
                        ...
                        <InputForm value={parentName} onChange={setParentName} placeholder="Tên phụ huynh" />
                    </WrapperInput>

                    <WrapperInput>
                        <WrapperLabel>SĐT PH</WrapperLabel>
                        <InputForm value={parentPhone} onChange={setParentPhone} placeholder="Số điện thoại phụ huynh" />
                    </WrapperInput>
                    ...
                    <WrapperInput>
                        ...
                        {avatar && (
                            <img src={avatar} alt="avatar" style={{ width: 60, height: 60, borderRadius: '50%', objectFit: 'cover' }} />
                        )}
                    </WrapperInput>

                    <WrapperInput>
                        <WrapperLabel>Đường</WrapperLabel>
                        <InputForm value={street} onChange={setStreet} placeholder="Tên đường/số nhà" />
                    </WrapperInput>
