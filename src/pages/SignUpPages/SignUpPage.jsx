...
const SignUpPage = () => {
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      const errorMessage =error?.response?.data?.Message || 'Có lỗi xảy ra. Vui lòng thử lại.'
    ...
    <div className="signup-container" >
      <div className="signup-form"  >
        <div className="signup-content">
          <h1>Hello Chess</h1>
          <p style={{ marginBottom:'10px' }}>Tạo tài khoản</p>
          <InputForm
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              {isShowPassword ? <EyeFilled className='Pic-Eye'/>: <EyeInvisibleFilled className='Pic-Eye'/>}
            </span>
            <InputForm 
          ...
          <div style={{position:'relative' }}>
            <span
              ...
              style={{ zIndex:10, position: 'absolute', top:'4px', right:'8px' }}
              >
                {isShowConfirmPassword ? <EyeFilled className='Pic-Eye'/>: <EyeInvisibleFilled className='Pic-Eye'/>}
            </span>
            <InputForm 
          ...
          {/* <Loading isLoading={isLoading}> */}
            ...
            />
          {/* </Loading> */}
          <p className='signup-link__text'>Bạn đã có tài khoản? <span className='link-navigate' onClick={handleNavigateSignIn}>Đăng Nhập</span> </p>
        </div>
      </div>
